...
#from geom import wrap_positions
...
class NPT3(MolecularDynamics):
    ...
    def run(self, steps):
        ...
        for i in range(steps):
            ...
            #if self.nsteps % 500 == 0:
            #    self._setbox_and_positions(self.h, self.q, wrap=True)
    ...
    def _setbox_and_positions(self, h, q, wrap=False):
        ...
        #if wrap:
        #    znum = self.atoms.get_atomic_numbers()
        #    box = self.atoms.cell.cellpar()[:3]
        #    r = wrap_positions (r, box, znum)
